...
helpers.generateValidators = function() {
  ...
  db.each(sql, params, (err, row) => {
    ...
    if (vote_address_index[`${vote_address}`] == null) {
      ...
      validator_stats["most_recent_apy"] = null;
      validator_stats["most_recent_marinade_staked"] = null;
      ...
      // Attach summary data of all epochs, overwrites to get the most recent
      if(row.apy){
        holder[vote_address_index[`${vote_address}`]]["most_recent_apy"] = row.apy
      }
      if(row.marinade_staked){
        holder[vote_address_index[`${vote_address}`]]["most_recent_marinade_staked"] = row.marinade_staked;
      }
