...
ORDER BY epoch DESC , scores2.rank ASC
   */
  let sql =
    "SELECT scores.epoch as epoch, scores.name,  NULL as rank, scores.pct, scores.score, scores.commission, scores.avg_position as average_active_stake, NULL as apy, NULL as delinquent, NULL as marinade_staked, NULL as should_have, scores.data_center_concentration \
    FROM scores2 \
