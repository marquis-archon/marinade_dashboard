...
helpers.generateValidators = function() {
  ...
  let sql =
    "SELECT scores.vote_address,scores.name,  scores.epoch, scores.pct, scores2.rank, scores2.score, scores2.credits_observed, scores2.commission, scores2.apy, scores2.marinade_staked, scores2.avg_active_stake \
    FROM scores \
    JOIN scores2 USING(vote_address) \
    UNION ALL \
    SELECT scores2.vote_address, scores2.name, scores2.epoch, scores2.pct, scores2.rank, scores2.score, scores2.credits_observed, scores2.commission, scores2.apy, scores2.marinade_staked,scores2.avg_active_stake \
    FROM scores2 \
